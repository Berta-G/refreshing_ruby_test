...
describe "Fizzbuzz with no mod" do

  it 'returns Fizz if 3 is received' do
    expect(modless_fizzbuzz 3).to eq("Fizz")
  end

  it 'returns Buzz if 5 is received' do
    expect(modless_fizzbuzz 5).to eq("Buzz")
  end

  it 'returns FizzBuzz if 15 is received' do
    expect(modless_fizzbuzz 15).to eq("FizzBuzz")
  end

  it 'returns 1 if 1 is received' do
    expect(modless_fizzbuzz 1).to eq(1)
  end
...
describe "Bottles of beer" do
  ...
  it 'returns bottle if 1 is received' do
    expect(bottle_s 1).to eq("bottle")
  end

  it 'returns bottles if 2 is received' do
    expect(bottle_s 2).to eq("bottles")
  end

  it 'returns no more if 0 is received' do
    expect(bottles_left 0).to eq("no more")
  end

  it 'returns 99 if -1 is received' do
    expect(bottles_left -1).to eq("99")
  end

  it 'returns 1 more if 1 is received' do
    expect(bottles_left 1).to eq("1")
  end
